...
import { transitionStepTool, decomposeSubgoalsTool } from "./tools/state-tools.js";
...
export const EnforcePlugin = async ({ client, directory }) => {
  ...
  return {
    ...
    tool: {
      ...
      transition_step: defineTool(transitionStepTool(context)),
      decompose_subgoals: defineTool(decomposeSubgoalsTool(context)),
    },
  };
};
